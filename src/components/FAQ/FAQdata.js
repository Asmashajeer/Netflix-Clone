const FAQdata=[
    ...
    {
        id:2,
        question:"Howmuch does Netflix cost ?",
        ans:`Watch Netflix on your smartphone, tablet, Smart TV, laptop, or streaming device, all for one fixed monthly fee. Plans range from AED 35 to AED 71 a month. No extra costs, no contracts.`
    },
    {
        id:3,
    ...
    {
        id:5,
        question:"Where can i watchon Netflix ?",
